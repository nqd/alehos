...
let createResHeaderName = function (reqName) {
  ...
  switch (reqName) {
    ...
    // light color
    case code.REQUEST_SET_COLOR:
      return code.RESPONSE_SET_COLOR

    case code.REQUEST_SET_COLOR_TEMPERATURE:
      return code.RESPONSE_SET_COLOR_TEMPERATURE

    case code.REQUEST_INC_COLOR_TEMPERATURE:
      return code.RESPONSE_INC_COLOR_TEMPERATURE

    case code.REQUEST_DEC_COLOR_TEMPERATURE:
      return code.RESPONSE_DEC_COLOR_TEMPERATURE

    // camera
    case code.REQUEST_RETRIEVE_CAMERA_STREAM_URI:
      return code.RESPONSE_RETRIEVE_CAMERA_STREAM_URI
  }
}
